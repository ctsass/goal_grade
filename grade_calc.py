...
exam_1 = (goal - 0.1*cp - 0.18*q - 0.18*t1 - 0.18*t2 - 0.18*t3) / 0.18

exam_1 = math.ceil(exam_1)

test_sum_drop_lowest = t1 + t2 + t3 - min(t1, t2, t3)

exam_2 = (goal - 0.1*cp - 0.18*q - 0.18*test_sum_drop_lowest) / 0.36
